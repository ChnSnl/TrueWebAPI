...
using TrueWebAPI.DesignPatterns.SingletonPattern;
using TrueWebAPI.Models;
using TrueWebAPI.Models.RequestModels;
using TrueWebAPI.Models.ResponseModels;
...
namespace TrueWebAPI.Controllers
{
    public class CategoryController : ApiController
    {
        ...
        {
            _db.Categories.Where(x => x.CategoryName.Contains(item)).Select(x => new CategoryResponseModel
            {
                ID = x.CategoryID,
                Name = x.CategoryName,
                Description = x.Description
